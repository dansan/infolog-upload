...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Infolog.ext_link'
        db.add_column(u'infolog_upload_infolog', 'ext_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Infolog.ext_link'
        db.delete_column(u'infolog_upload_infolog', 'ext_link')
